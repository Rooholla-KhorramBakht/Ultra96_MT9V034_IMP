...
set DataType0 [list "narrow_stream" "struct narrow_stream" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "stream_out_32"
set BitWidth1 "64"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType1 [list "wide_stream" "struct wide_stream" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
