...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("stream_in_24_TVALID", 1, hls_in, 2, "axis", "in_vld", 1),
	Port_Property("stream_in_24_TREADY", 1, hls_out, 2, "axis", "in_acc", 1),
	Port_Property("stream_in_24_TUSER", 1, hls_in, 1, "axis", "in_data", 1),
	Port_Property("stream_in_24_TLAST", 1, hls_in, 2, "axis", "in_data", 1),
	Port_Property("stream_out_32_TDATA", 32, hls_out, 3, "axis", "out_data", 1),
	Port_Property("stream_out_32_TVALID", 1, hls_out, 5, "axis", "out_vld", 1),
	Port_Property("stream_out_32_TREADY", 1, hls_in, 5, "axis", "out_acc", 1),
	Port_Property("stream_out_32_TUSER", 1, hls_out, 4, "axis", "out_data", 1),
	Port_Property("stream_out_32_TLAST", 1, hls_out, 5, "axis", "out_data", 1),
