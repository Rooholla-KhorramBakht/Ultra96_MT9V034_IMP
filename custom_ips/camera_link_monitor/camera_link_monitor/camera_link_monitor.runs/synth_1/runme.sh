...
HD_PWD='D:/project_1/custom_ips/camera_link_monitor/camera_link_monitor/camera_link_monitor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cam_line_status.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cam_line_status.tcl
