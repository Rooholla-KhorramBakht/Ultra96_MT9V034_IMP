...
#ifndef __color_convert_maccud__HH__
#define __color_convert_maccud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(color_convert_maccud) {
    ...
    SC_CTOR(color_convert_maccud):  simcore_mac_1_U ("simcore_mac_1_U") {
