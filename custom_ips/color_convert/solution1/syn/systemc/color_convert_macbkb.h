...
#ifndef __color_convert_macbkb__HH__
#define __color_convert_macbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(color_convert_macbkb) {
    ...
    SC_CTOR(color_convert_macbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
