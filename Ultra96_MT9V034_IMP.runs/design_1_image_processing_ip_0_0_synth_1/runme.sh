...
HD_PWD='D:/Ultra96_MT9V034_Basic/Ultra96_MT9V034_Basic.runs/design_1_image_processing_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_image_processing_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_image_processing_ip_0_0.tcl
