...
proc create_root_design { parentCell } {
  ...
  set config_i2c [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 config_i2c ]

  # Create ports
  set cam_pixel_clk [ create_bd_port -dir I -type clk cam_pixel_clk ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {26666667} \
 ] $cam_pixel_clk
  set frame_valid [ create_bd_port -dir I -from 0 -to 0 frame_valid ]
  set line_valid [ create_bd_port -dir I -from 0 -to 0 line_valid ]
  set pixel_data [ create_bd_port -dir I -from 7 -to 0 pixel_data ]
  ...
  # Create instance: cam_line_status_0, and set properties
  set cam_line_status_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:cam_line_status:1.0 cam_line_status_0 ]
  ...
  set image_processing_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:image_processing_ip:1.0 image_processing_ip_0 ]
  ...
  # Create instance: proc_sys_reset_27M, and set properties
  set proc_sys_reset_27M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_27M ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__I2C0_REF_CTRL__ACT_FREQMHZ {100.000002} \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {150.000003} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {8} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {150} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__SRCSEL {RPLL} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {26.666667} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR0 {45} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__FREQMHZ {27} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins axi_interconnect_1/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M02_AXI [get_bd_intf_pins axi_interconnect_1/M02_AXI] [get_bd_intf_pins color_convert_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net axi_interconnect_1_M03_AXI [get_bd_intf_pins axi_interconnect_1/M03_AXI] [get_bd_intf_pins pixel_pack_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net axi_interconnect_1_M04_AXI [get_bd_intf_pins axi_interconnect_1/M04_AXI] [get_bd_intf_pins axis_switch_0/S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_interconnect_1_M05_AXI [get_bd_intf_pins axi_interconnect_1/M05_AXI] [get_bd_intf_pins axis_switch_1/S_AXI_CTRL]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins axis_switch_0/S00_AXIS]
  connect_bd_intf_net -intf_net axis_switch_0_M00_AXIS [get_bd_intf_pins axis_switch_0/M00_AXIS] [get_bd_intf_pins axis_switch_1/S00_AXIS]
  connect_bd_intf_net -intf_net axis_switch_0_M01_AXIS [get_bd_intf_pins axis_switch_0/M01_AXIS] [get_bd_intf_pins image_processing_ip_0/INPUT_STREAM]
  connect_bd_intf_net -intf_net axis_switch_1_M00_AXIS [get_bd_intf_pins axis_switch_1/M00_AXIS] [get_bd_intf_pins pixel_pack_0/stream_in_24]
  connect_bd_intf_net -intf_net color_convert_0_stream_out_24 [get_bd_intf_pins axis_register_slice_0/S_AXIS] [get_bd_intf_pins color_convert_0/stream_out_24]
  connect_bd_intf_net -intf_net image_processing_ip_0_OUTPUT_STREAM1 [get_bd_intf_pins axis_switch_1/S01_AXIS] [get_bd_intf_pins image_processing_ip_0/OUTPUT_STREAM1]
  ...
  connect_bd_intf_net -intf_net v_cfa_0_video_out [get_bd_intf_pins color_convert_0/stream_in_24] [get_bd_intf_pins v_cfa_0/video_out]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_IIC_0 [get_bd_intf_ports config_i2c] [get_bd_intf_pins zynq_ultra_ps_e_0/IIC_0]
  ...
  connect_bd_net -net Op1_0_1 [get_bd_ports line_valid] [get_bd_pins cam_line_status_0/LV] [get_bd_pins ila_0/probe2] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net Op2_0_1 [get_bd_ports frame_valid] [get_bd_pins cam_line_status_0/FV] [get_bd_pins ila_0/probe3] [get_bd_pins util_vector_logic_0/Op2] [get_bd_pins util_vector_logic_2/Op1]
  ...
  connect_bd_net -net cam_line_status_0_col [get_bd_pins cam_line_status_0/col] [get_bd_pins ila_0/probe1]
  connect_bd_net -net cam_line_status_0_link_state [get_bd_pins cam_line_status_0/link_state] [get_bd_pins ila_0/probe4] [get_bd_pins proc_sys_reset_27M/aux_reset_in] [get_bd_pins v_vid_in_axi4s_0/axis_enable]
  connect_bd_net -net cam_line_status_0_row [get_bd_pins cam_line_status_0/row] [get_bd_pins ila_0/probe0]
  connect_bd_net -net proc_sys_reset_27M_peripheral_reset [get_bd_pins proc_sys_reset_27M/peripheral_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
  connect_bd_net -net rst_ps8_0_100M_interconnect_aresetn [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins rst_ps8_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins cam_line_status_0/rst] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_150M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_ps8_0_150M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_150M_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/M03_ARESETN] [get_bd_pins axi_interconnect_1/M04_ARESETN] [get_bd_pins axi_interconnect_1/M05_ARESETN] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_switch_0/aresetn] [get_bd_pins axis_switch_0/s_axi_ctrl_aresetn] [get_bd_pins axis_switch_1/aresetn] [get_bd_pins axis_switch_1/s_axi_ctrl_aresetn] [get_bd_pins color_convert_0/ap_rst_n] [get_bd_pins color_convert_0/ap_rst_n_control] [get_bd_pins image_processing_ip_0/ap_rst_n] [get_bd_pins pixel_pack_0/ap_rst_n] [get_bd_pins pixel_pack_0/ap_rst_n_control] [get_bd_pins rst_ps8_0_150M/peripheral_aresetn] [get_bd_pins v_cfa_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_ports cam_pixel_clk] [get_bd_pins cam_line_status_0/clk] [get_bd_pins ila_0/probe5] [get_bd_pins proc_sys_reset_27M/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  ...
  connect_bd_net -net vid_data_0_1 [get_bd_ports pixel_data] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins image_processing_ip_0/ap_start] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins ila_0/clk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/M03_ACLK] [get_bd_pins axi_interconnect_1/M04_ACLK] [get_bd_pins axi_interconnect_1/M05_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_switch_0/aclk] [get_bd_pins axis_switch_0/s_axi_ctrl_aclk] [get_bd_pins axis_switch_1/aclk] [get_bd_pins axis_switch_1/s_axi_ctrl_aclk] [get_bd_pins color_convert_0/ap_clk] [get_bd_pins color_convert_0/control] [get_bd_pins image_processing_ip_0/ap_clk] [get_bd_pins pixel_pack_0/ap_clk] [get_bd_pins pixel_pack_0/control] [get_bd_pins rst_ps8_0_150M/slowest_sync_clk] [get_bd_pins v_cfa_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_27M/ext_reset_in] [get_bd_pins rst_ps8_0_100M/ext_reset_in] [get_bd_pins rst_ps8_0_150M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_switch_0/S_AXI_CTRL/Reg] SEG_axis_switch_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0003000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_switch_1/S_AXI_CTRL/Reg] SEG_axis_switch_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs color_convert_0/s_axi_AXILiteS/Reg] SEG_color_convert_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pixel_pack_0/s_axi_AXILiteS/Reg] SEG_pixel_pack_0_Reg
  ...
  exclude_bd_addr_seg [get_bd_addr_segs axi_vdma_0/Data_MM2S/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]
  ...
  exclude_bd_addr_seg [get_bd_addr_segs axi_vdma_0/Data_S2MM/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]
