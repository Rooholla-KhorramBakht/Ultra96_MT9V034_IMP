...
import "DPI-C" function void ps8_simulate_single_cycle_pl_clk2();
...
//INITIAL BLOCK
  ...
  always #(3.3333333333333335) pl_clk1 <= ~pl_clk1;
  ...
  always #(18.51851851851852) pl_clk2 <= ~pl_clk2;

  always@(posedge pl_clk2)
  begin
   ps8_set_ip_context(ip_name);
   ps8_simulate_single_cycle_pl_clk2();
  end
